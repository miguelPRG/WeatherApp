  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <AreaChart data={data}>
        ...
        <Tooltip />
        <Legend align="center" />
        <Area type="monotone" dataKey="Avg" stroke="#ffc658" fill="#ffc658" stackId="1" />
        <Area type="monotone" dataKey="Max" stroke="#82ca9d" fill="#82ca9d" stackId="1" />
        <Area type="monotone" dataKey="Min" stroke="#8884d8" fill="#8884d8" stackId="1" />
      </AreaChart>
    </ResponsiveContainer>
  );
}
  ...
  return (
    <>
      <div className="flex gap-2">
        <button
          className="chart-btn"
          onClick={() => setMetric("Min")}>Min</button>
        <button
          className="chart-btn"
          onClick={() => setMetric("Avg")}>Avg</button>
        <button
          className="chart-btn"
          onClick={() => setMetric("Max")}>Max</button>
      </div>
      <ResponsiveContainer width="100%" height={260}>
        <RadialBarChart innerRadius="10%" outerRadius="80%" barSize={10} data={data}>
          ...
          <Legend iconSize={10} layout="vertical" verticalAlign="middle" align="right" wrapperStyle={style} />
        </RadialBarChart>
      </ResponsiveContainer>
    </>
  )
...
export { LineChartComponent, BarChartComponent, AreaChartComponent, ComposedChartComponent, RadialBarChartComponent };